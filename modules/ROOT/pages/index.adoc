...
=== Resource kinds
Furthermore, following <<COOL-URIS>> (among others), we distinguish between three kinds of resources: _documentation resources_, _data resources_ and _real-world entities or concepts_.
