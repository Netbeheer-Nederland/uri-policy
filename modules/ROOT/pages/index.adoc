...
|===
| Author
| Bart Kleijngeld, Alliander (bart.kleijngeld@alliander.com)
.2+| Editors
a| Ritger Teunissen, Alliander (ritger.teunissen@alliander.com)
a| Robbert Hardin, Alliander (robbert.hardin@alliander.com)
...
=== Resource kinds
Furthermore, following <<COOL-URIS>> (among others), we distinguish between three kinds of resources: _documentation information resources_, _data information resources_ and _real-world entities or concepts_.
