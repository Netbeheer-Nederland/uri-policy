...
This document lays out a standardized way for assigning <<RFC3987,IRI>> (_Internationalized Resource Identifiers_) to resources for the power and utilities industry. This ensures that resources can be unambiguously and consistently identified on the web, enabling the reliable linking, discovery, and integration of data, advancing the broader goal of making data FAIR by adopting the <<LD,Linked Data principles>>. This will contribute to a more connected, efficient, and sustainable power and utilities data ecosystem.
