...
This document lays out a standardized way for assigning <<RFC3987,IRI>> (_Internationalized Resource Identifiers_) to resources for the power and utilities industry. This ensure that resources can be unambiguously and consistently identified on the web, enabling the reliable linking, discovery, and integration of data, advancing the broader goal of making data FAIR by adopting the <<LD,Linked Data principles>>. This will contribute to a more connected, efficient, and sustainable power and utilities data ecosystem.
...
<<def-resource,Resources>> and their representations are identified by IRIs, each of which _MUST_ be of the following form:
...
NOTE: This is much like a dedicated register, but data products are information resources whereas register entities are not. Therefore, to avoid confusion, and because data products are important, this special category has been introduced.
