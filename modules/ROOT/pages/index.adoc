...
Furthermore, following <<COOL-URIS>> (among others), we distinguish between three kinds of resources, each of which will be explained in the following sections.
...
* **_documentation information resources_**, colloquially referred to as _web pages_ (indicated by the `www` subdomain)
* **_data information resources_** (indicated by the `data` subdomain)
...
Each resource can have several resources of different kinds associated with it, as is illustrated in the following example.
...
A resource can have a variety of representations associated with them. Each of those representations are themselves information resources, either of the data or documentation kind.

=== Real-world entities and concepts

As discussed in <<resources-and-resource-kinds>>, resources which represent real-world entities or concepts are not information resources and therefore do not have an inherent representation on the web. However, other information resources can represent them.
